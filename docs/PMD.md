...
- [Code Analyzer Config](CODE_ANALYZER_CONFIG.md) - `code-analyzer.yml`
  reference
...
When undefined, `${propertyName}` stays literal → check true → default used. See
[AI Agent Rule Guide](AI_AGENT_RULE_GUIDE.md#property-configuration-for-xpathrule).
...
[APEX_PMD_AST.md](APEX_PMD_AST.md)
